...
namespace Persistence.Migrations
{
    ...
    [Migration("20230418110057_InitialMigration")]
            ...
            modelBuilder.Entity("Core.Entities.Report", b =>
                {
                    ...
                    b.HasOne("Core.Entities.ChatMember", null)
                        .WithMany("Reports")
                        .HasForeignKey("ChatMemberId");

                    b.HasOne("Core.Entities.ChatMessage", null)
                        .WithMany("Reports")
                        .HasForeignKey("ChatMessageId");

                    b.HasOne("Core.Entities.Comment", null)
                        .WithMany("Reports")
                        .HasForeignKey("CommentId");
                    ...
                    b.HasOne("Core.Entities.GroupUser", null)
                        .WithMany("Reports")
                    ...
                    b.HasOne("Core.Entities.PollOption", null)
                        .WithMany("Reports")
                        .HasForeignKey("PollOptionId");

                    b.HasOne("Core.Entities.PostComment", null)
                        .WithMany("Reports")
                    ...
                    b.HasOne("Core.Entities.UserSession", null)
                        .WithMany("Reports")
